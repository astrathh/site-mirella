      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <FadeInUp>
          <section className="text-center mb-16">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#2E4365] mb-6">Insights sobre Social Media</h1>
        ...
        <section>
          <FadeInUp delay={300}>
            <h2 className="text-3xl font-bold text-[#2E4365] mb-8 text-center">Todos os Posts</h2>
          </FadeInUp>
